...
export function Header1() {
    return (
        <section className="prose max-w-none bg-no-repeat bg-cover bg-center" style={{backgroundImage: `url(${'/img/freelancer-template0-header1-white-bg.png'})`}}>
            <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-20">
                ...
                <div className="min-h-[400px]">
                    <Image src="/img/freelancer-template0-aboutme1-avatar.jpg" alt="" className="mx-auto inline-block rounded-full" width={400} height={800} style={{objectFit: "contain"}}/>
                </div>
                </div>
            </div>
        </section>

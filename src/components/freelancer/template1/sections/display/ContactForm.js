                ...
                <div className="mx-auto w-full max-w-[400px]">
                    ...
                    <div className="mx-auto max-w-[400px] text-left my-4">
                        <form name="wf-form-password" onSubmit={submitForm}>
                            ...
                            <input type="submit" disabled={loading || disabled || !publish} value={loading ? "Sending..." : section.formBtn.text} className={`${section.formBtn && section.formBtn.color ? btnColorOptions[section.formBtn.color] : btnColorOptions['orange']} m-0 inline-block w-full cursor-pointer items-center px-6 py-3 text-center font-semibold`}/>
                        </form>
                    </div>
                </div>
            </div>

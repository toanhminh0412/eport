...
export function EditableNavbar1({ section, sectionInd }) {
    ...
    return (
        <div className="group">
            <button className="btn bg-blue-700 border-none z-40 absolute hover:bg-blue-900 top-[-35px] right-0 mr-7 hidden group-hover:block" onClick={()=>document.getElementById('delete_modal').showModal()}><i className="fa-solid fa-trash text-lg text-white"></i></button>
            ...
            <div className={`navbar bg-black/50 z-10 lg:absolute w-full min-w-[450px] border-4 ${activeSectionInd === sectionInd ? "border-blue-700" : "border-transparent"} group-hover:border-blue-700 duration-200`} onClick={openContentTabEditor}>

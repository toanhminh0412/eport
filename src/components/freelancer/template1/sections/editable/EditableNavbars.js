...
export function EditableNavbar1({ section, sectionInd }) {
    ...
    return (
        <div className={`navbar group bg-black/50 z-10 lg:absolute w-full min-w-[450px] border-4 ${activeSectionInd === sectionInd ? "border-blue-700" : "border-transparent"} hover:border-blue-700 hover:pr-24 duration-200`} onClick={openContentTabEditor}>

...
export function EditableAboutMe1({ section, sectionInd }) {
    ...
    return (
        <div className="group relative">
            <button className="btn bg-blue-700 border-none z-40 absolute hover:bg-blue-900 top-[-35px] right-0 mr-7 hidden group-hover:block" onClick={()=>document.getElementById('delete_modal_aboutme1').showModal()}><i className="fa-solid fa-trash text-lg text-white"></i></button>

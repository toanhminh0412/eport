...
export function EditableHeader2({ section, sectionInd }) {
    ...
    return (
        <div className="group relative" style={{zoom: "60%"}}>
            ...
            <header style={{backgroundImage: `url(${section.backgroundImage})`}} className={`relative w-full flex flex-row bg-black bg-cover box-border border-4 ${activeSectionInd === sectionInd ? "border-blue-700" : "border-transparent"} hover:border-blue-700 duration-200`} onClick={openContentTabEditor}>
                {/* This div allows scrolling to this section put the section in the middle of the page */}
                <div id={section.id} className="absolute top-[-250px]"></div>
                {/* Hero Container */}

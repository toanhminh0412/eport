        ...
        <div className="collapse collapse-arrow border border-slate-300 dark:border-slate-600">
            ...
            <div className="collapse-content bg-white dark:bg-slate-900">
                <div className="p-3 md:p-6">
                    ...
                    :
                        <div className="mt-6">
                            <div className="btn bg-blue-500 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-900 dark:border-blue-700 text-white duration-200 mt-2 relative" onClick={() => window.ask_login_modal.showModal()}>Upload CV</div>
                        </div>
                    }
                </div>
            </div>

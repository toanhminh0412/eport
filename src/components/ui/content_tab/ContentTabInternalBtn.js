export default function ContentTabInternalBtn({ content, onChange, onDelete=null, sections, activeSectionInd }) {
    const {text, internalHref, externalHref, isExternal, color} = content;

                ...
                <div className="p-3 md:p-6">
                    <div className="mt-4">
                        <div className="form-control w-full max-w-lg">
                            ...
                            {/* Heading */}
                            <label className="label">
                                <span className="label-text">Section heading  (recommend &apos;References&apos;):</span>
                            </label>
                            <input ref={el => (referencesRef.current['heading'] = el)} type="text" placeholder="Section heading (recommend 'References')" className="input border-black w-full" defaultValue={references.heading} />
                            ...
                            <div className="form-control">
                                ...
                                <div key={reference.id} className={`${refIndex === 0 ? '' : 'mt-12'} w-full`}>
                                    ...
                                    <label className="label max-w-lg mt-2">
                                        <span className="label-text">Referrer&apos;s relationship:</span>
                                    </label>
                                    <input 
                                    ...
                                    {/* Phone */}
                                    <label className="label max-w-lg">
                                        <span className="label-text">Referrer&apos;s phone:</span>
                                    </label>
                                    <input 
                                    ...
                                    {/* Email */}
                                    <label className="label max-w-lg">
                                        <span className="label-text">Referrer&apos;s email:</span>
                                    </label>
                                    <input 
                                    ...
                                    {/* LinkedIn */}
                                    <label className="label max-w-lg">
                                        <span className="label-text">Referrer&apos;s LinkedIn:</span>
                                    </label>
                                    <input 
